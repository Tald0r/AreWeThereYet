...
public class AreWeThereYet : BaseSettingsPlugin<AreWeThereYetSettings>
{
    ...
    public override Job Tick()
    {
        ...
        if (_followTarget != null)
        {
            ...
            else
            {
                ...
                else if (!_hasUsedWP && Settings.TakeWaypoints.Value)
                {
    ...
    public override void Render()
    {
        ...
        Graphics.DrawText("AutoPilot: Active", new System.Numerics.Vector2(350, 120));
        Graphics.DrawText("Coroutine: " + (Settings.IsFollowEnabled.Value ? "Active" : "Dead"), new System.Numerics.Vector2(350, 140));
        Graphics.DrawText("Leader: " + (_followTarget != null ? "Found" : "Null"), new System.Numerics.Vector2(350, 160));
        Graphics.DrawLine(new System.Numerics.Vector2(490, 120), new System.Numerics.Vector2(490,180), 1, SharpDX.Color.White);
    }
